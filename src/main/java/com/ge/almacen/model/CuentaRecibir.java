...
import com.ge.almacen.enums.EstadoCuentaRecibir;
...
public class CuentaRecibir implements Serializable {
	...
	@Column(name = "estado_cuenta_recibir", nullable = false)
	private EstadoCuentaRecibir estadoCuentaRecibir;
	...
	public EstadoCuentaRecibir getEstadoCuentaRecibir() {
		return estadoCuentaRecibir;
	}

	public void setEstadoCuentaRecibir(EstadoCuentaRecibir estadoCuentaRecibir) {
		this.estadoCuentaRecibir = estadoCuentaRecibir;
	}
